...
const DetailsPage = () => {
  ...
  const handleSaveToWatchlist = () => {
    ...
    localStorage.setItem("watchlist", JSON.stringify([...watchlist, watchlistItem]));
  ...
  useEffect(() => {
    ...
    const watchlist = JSON.parse(localStorage.getItem("watchlist")) || [];
    const isItemInWatchlist = watchlist.some((item) => item.id.toString() === id);
    setIsInWatchlist(isItemInWatchlist);
  }, [id, user]);

  const handleRemoveFromWatchlist = () => {
    const watchlist = JSON.parse(localStorage.getItem("watchlist")) || [];
    const updatedWatchlist = watchlist.filter((item) => item.id.toString() !== id);
